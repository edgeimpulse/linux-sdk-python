...
def help():
    print('python classify-image.py <path_to_model.eim> <path_to_image.jpg> width height')
...
def main(argv):
    ...
    with ImageImpulseRunner(modelfile) as runner:
        try:
            ...
            model_info = runner.init(debug=True, dynamic_input_size = (96, 96, 3))
            # set dynamic input size, only RGB for now
